...
library(anndataR)
library(abind)
googlepath="G:/Mon Drive/UG_metacells/McExplorer_cell_lineages/"
load("C:/Users/E134321B/Desktop/Work stuff/Trebuchet/testfig/run_objects_amasauce/all_genes.rd")

load("G:/Mon Drive/UG_metacells/Figures paper Juin/All_prop/dfall_IBD_MoMac.rd")
load("G:/Mon Drive/UG_metacells/Figures paper Juin/All_prop/dfall_IBD_Mono.rd")
load("G:/Mon Drive/UG_metacells/Figures paper Juin/All_prop/dfall_IBD_Macro.rd")
load("G:/Mon Drive/UG_metacells/Figures paper Juin/All_prop/dfall_IBD_Bcells.rd")
load("G:/Mon Drive/UG_metacells/Figures paper Juin/All_prop/dfall_IBD_DC.rd")
load("G:/Mon Drive/UG_metacells/Figures paper Juin/All_prop/dfall_IBD_Fibro.rd")
load("G:/Mon Drive/UG_metacells/Figures paper Juin/All_prop/dfall_IBD_PC.rd")
load("G:/Mon Drive/UG_metacells/Figures paper Juin/All_prop/dfall_IBD_Tcells.rd")
load("G:/Mon Drive/UG_metacells/Figures paper Juin/All_prop/dfall_IBD_EndoC.rd")
load("G:/Mon Drive/UG_metacells/Figures paper Juin/All_prop/dfall_IBD_GliPerSM_detailed.rd")
# Mast : osef
...
save(dfall_all_df3CD,file="G:/Mon Drive/UG_metacells/Figures paper Juin/All_prop/dfall_IBD_all_df3CD.rd")

#MoMacs:
load(paste0(googlepath,"df_mcall_Macs_select2.rd"))
clean_lin1<-anndata::read_h5ad('C:/Users/E134321B/Desktop/Work stuff/Trebuchet/RDcr5/ldmcr5/Myel_tot_dec22/all_clean_Totalldec_MacsfromMNP_select2.h5ad')
...
save(MoMac_obj, file="C:/Users/E134321B/Desktop/Work stuff/Trebuchet/testfig/run_objects_amasauce/MoMac_obj.rd")
...
save(Mono_obj, file="C:/Users/E134321B/Desktop/Work stuff/Trebuchet/testfig/run_objects_amasauce/Mono_obj.rd")
...
save(Macro_obj, file="C:/Users/E134321B/Desktop/Work stuff/Trebuchet/testfig/run_objects_amasauce/Macro_obj.rd")

#Bcells:
load(paste0(googlepath,"SubsetsAppObj/df_mcall_Totdec_B.rd"))
clean_lin1<-anndata::read_h5ad('C:/Users/E134321B/Desktop/Work stuff/Trebuchet/RDcr5/ldmcr5/Myel_tot_dec22/all_clean_Totalldec_B.h5ad')
df_lin1_cd_inf<-df[which(df$sample%in%df3CD_o1),]
...
save(Bcells_obj, file="C:/Users/E134321B/Desktop/Work stuff/Trebuchet/testfig/run_objects_amasauce/Bcells_obj.rd")

#DC:
load(paste0(googlepath,"df_mcall_DC_select2.rd"))
clean_lin1<-anndata::read_h5ad('C:/Users/E134321B/Desktop/Work stuff/Trebuchet/RDcr5/ldmcr5/Myel_tot_dec22/all_clean_Totalldec_DCfromMNP_select2.h5ad')
df_lin1_cd_inf<-df[which(df$sample%in%df3CD_o1),]
...
save(DC_obj, file="C:/Users/E134321B/Desktop/Work stuff/Trebuchet/testfig/run_objects_amasauce/DC_obj.rd")

#Fibro:
load(paste0(googlepath,"SubsetsAppObj/df_mcall_Totdec_StrGli_Fibro.rd"))
clean_lin1<-anndata::read_h5ad('C:/Users/E134321B/Desktop/Work stuff/Trebuchet/RDcr5/ldmcr5/Myel_tot_dec22/all_clean_Totdec_StrGli_Fibro.h5ad')
df_lin1_cd_inf<-df[which(df$sample%in%df3CD_o1),]
...
save(Fibro_obj, file="C:/Users/E134321B/Desktop/Work stuff/Trebuchet/testfig/run_objects_amasauce/Fibro_obj.rd")

#PC:
load(paste0(googlepath,"SubsetsAppObj/df_Totdec_PlasmaCells.rd"))
clean_lin1<-anndataR::read_h5ad('C:/Users/E134321B/Desktop/Work stuff/Trebuchet/RDcr5/ldmcr5/Myel_tot_dec22/all_clean_Totdec_PlasmaCells.h5ad')
...
save(PC_obj, file="C:/Users/E134321B/Desktop/Work stuff/Trebuchet/testfig/run_objects_amasauce/PC_obj.rd")

#Tcells:
load(paste0(googlepath,"SubsetsAppObj/df_Totdec_Tcellsmini.rd"))
clean_lin1<-anndataR::read_h5ad('C:/Users/E134321B/Desktop/Work stuff/Trebuchet/RDcr5/ldmcr5/Myel_tot_dec22/all_clean_Totdec_mini_Tcells_oct24redo.h5ad')
colnames(clean_lin1$X)<-clean_lin1$var_names
rownames(clean_lin1$X)<-clean_lin1$obs_names
df_lin1_cd_inf<-df[which(df$sample%in%df3CD_o1),]
# ncm_NNN<-mean_pat_fct(cl_lin=clean_lin1,df_lin=df_lin1_cd_inf,lin_choice="NNN")
...
save(Tcells_obj, file="C:/Users/E134321B/Desktop/Work stuff/Trebuchet/testfig/run_objects_amasauce/Tcells_obj.rd")

#EndoC:
load(paste0(googlepath,"SubsetsAppObj/df_Totdec_StrGli_EndoC.rd"))
clean_lin1<-anndataR::read_h5ad('C:/Users/E134321B/Desktop/Work stuff/Trebuchet/RDcr5/ldmcr5/Myel_tot_dec22/all_clean_Totdec_StrGli_EndoC.h5ad')
colnames(clean_lin1$X)<-clean_lin1$var_names
rownames(clean_lin1$X)<-clean_lin1$obs_names
df_lin1_cd_inf<-df[which(df$sample%in%df3CD_o1),]
# ncm_NNN<-mean_pat_fct(cl_lin=clean_lin1,df_lin=df_lin1_cd_inf,lin_choice="NNN")
...
save(EndoC_obj, file="C:/Users/E134321B/Desktop/Work stuff/Trebuchet/testfig/run_objects_amasauce/EndoC_obj.rd")

#GliPerSM:
load(paste0(googlepath,"SubsetsAppObj/df_Totdec_StrGli_GliPerSM.rd"))
clean_lin1<-anndataR::read_h5ad('C:/Users/E134321B/Desktop/Work stuff/Trebuchet/RDcr5/ldmcr5/Myel_tot_dec22/all_clean_Totdec_StrGli_GliPerSM.h5ad')
colnames(clean_lin1$X)<-clean_lin1$var_names
rownames(clean_lin1$X)<-clean_lin1$obs_names
df_lin1_cd_inf<-df[which(df$sample%in%df3CD_o1),]
# ncm_NNN<-mean_pat_fct(cl_lin=clean_lin1,df_lin=df_lin1_cd_inf,lin_choice="NNN")
...
save(GliPerSM_obj, file="C:/Users/E134321B/Desktop/Work stuff/Trebuchet/testfig/run_objects_amasauce/GliPerSM_detailed_obj.rd")
...
library(anndataR)
library(abind)
googlepath="G:/Mon Drive/UG_metacells/laurent_et_al_2025/Figure 8S/"
...
## is_ppi : I guess it's for protein-protein interactions
...
save(validated_pairs_CpDB, file="C:/Users/E134321B/Desktop/Work stuff/Trebuchet/testfig/run_objects_amasauce/validated_pairs_CpDB.rd")
...
#load("C:/Users/E134321B/Desktop/Work stuff/Trebuchet/testfig/run_objects_amasauce/MoMac_obj.rd")
load("C:/Users/E134321B/Desktop/Work stuff/Trebuchet/testfig/run_objects_amasauce/Mono_obj.rd")
load("C:/Users/E134321B/Desktop/Work stuff/Trebuchet/testfig/run_objects_amasauce/Macro_obj.rd")
load("C:/Users/E134321B/Desktop/Work stuff/Trebuchet/testfig/run_objects_amasauce/Bcells_obj.rd")
load("C:/Users/E134321B/Desktop/Work stuff/Trebuchet/testfig/run_objects_amasauce/DC_obj.rd")
load("C:/Users/E134321B/Desktop/Work stuff/Trebuchet/testfig/run_objects_amasauce/Fibro_obj.rd")
load("C:/Users/E134321B/Desktop/Work stuff/Trebuchet/testfig/run_objects_amasauce/PC_obj.rd")
load("C:/Users/E134321B/Desktop/Work stuff/Trebuchet/testfig/run_objects_amasauce/Tcells_obj.rd")
load("C:/Users/E134321B/Desktop/Work stuff/Trebuchet/testfig/run_objects_amasauce/EndoC_obj.rd")
load("C:/Users/E134321B/Desktop/Work stuff/Trebuchet/testfig/run_objects_amasauce/GliPerSM_detailed_obj.rd")
...
load("C:/Users/E134321B/Desktop/Work stuff/Trebuchet/testfig/run_objects_amasauce/validated_pairs_CpDB.rd")
...
load("~/laurent_et_al_2025/Grouped_objects/dfall_IBD_all_df3CD.rd")
...
load("~/laurent_et_al_2025/Grouped_objects/umitab_all_maj_lin_fev25.rd")
umitab_all_maj_lin<-Matrix::t(umitab_all_maj_lin)
tables_output_path = "~/laurent_et_al_2025/Figure 8S/"
