...
excl = pd.read_csv("cells_to_keep_DC_inMNPenrich.csv")
...
plot.get_figure().savefig("clean16nov22DC.png") 
clean.write('all_clean_all_16nov22_DC.h5ad') 
metacells.write('all__16nov22_DC.h5ad')
